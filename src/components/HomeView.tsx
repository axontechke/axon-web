          ...
          <section className="max-w-7xl mx-auto px-3 sm:px-6 space-y-3 sm:space-y-4" id="mixed-picks-section">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-2 sm:gap-4">
              {mixedProducts.map((product) => (
                <div
                  key={product.id}
                  className="bg-surface rounded-xl md:rounded-[24px] border border-outline/10 p-2 sm:p-3 flex flex-col justify-between group transition-all hover:shadow-xs"
                  id={`mixed-${product.id}`}
                >
                  <div
                  ...
                  >
                    <div className="relative h-24 sm:h-28 md:h-36 rounded-lg md:rounded-2xl bg-surface-container-lowest flex items-center justify-center p-2 overflow-hidden border border-outline/5">
                      {product.isNew && (
            ...
            return trendingList.map((slotItem, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative w-full flex justify-center items-center bg-surface-container-lowest rounded-2xl">
