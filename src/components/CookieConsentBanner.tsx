          ...
          <div className="max-w-2xl mx-auto pointer-events-auto rounded-2xl border border-outline-variant/40 bg-surface-container-low/95 backdrop-blur-xl shadow-2xl shadow-black/10 dark:shadow-black/30 dark:bg-surface-container-high/95 dark:border-outline-variant/20">
            ...
            <div className="flex items-start gap-2.5 sm:gap-3 px-3.5 sm:px-5 pt-3 sm:pt-4 pb-2.5 sm:pb-3">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-[13px] sm:text-sm font-semibold text-on-surface font-display tracking-tight">
                  We value your privacy
                </h3>
                <p className="mt-0.5 sm:mt-1 text-[11px] sm:text-xs leading-relaxed text-on-surface-variant">
            ...
            {/* Action row */}
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 px-3.5 sm:px-5 pb-3 sm:pb-4 pt-1">
              <button
                onClick={() => setExpanded(!expanded)}
                className="order-2 sm:order-1 w-full sm:w-auto flex items-center justify-center gap-1 px-3 py-2 text-[11px] sm:text-xs font-medium text-on-surface-variant hover:text-on-surface rounded-xl hover:bg-surface-container transition-colors"
              >
                {expanded ? (
                  <>
              ...
              <div className="order-1 sm:order-2 flex items-center gap-2 sm:flex-1 sm:justify-end">
                <button
                  onClick={decline}
                  className="flex-1 sm:flex-none justify-center px-4 py-2 text-[11px] sm:text-xs font-semibold rounded-xl border border-outline-variant/60 text-on-surface-variant hover:bg-surface-container hover:border-outline transition-all"
                >
                  Decline
                </button>
                ...
                <button
                  onClick={accept}
                  className="glass-btn-ios-primary flex-1 sm:flex-none justify-center px-5 py-2 text-[11px] sm:text-xs font-semibold rounded-xl"
                >
                  Accept Cookies
                </button>
              </div>
