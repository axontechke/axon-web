...
const INITIAL_CONTACT: Record<string, any> = {
  ...
  socials: [
    { name: "WhatsApp", url: "https://wa.me/254745017979", icon: "https://img.icons8.com/color/48/whatsapp--v1.png" },
    { name: "Instagram", url: "https://instagram.com/axontechke", icon: "https://img.icons8.com/color/48/instagram-new--v1.png" },
    { name: "Facebook", url: "https://facebook.com/axontechke", icon: "https://img.icons8.com/color/48/facebook--v1.png" },
    { name: "TikTok", url: "https://tiktok.com/@axontechke", icon: "https://img.icons8.com/color/48/tiktok--v1.png" }
  ]
};
